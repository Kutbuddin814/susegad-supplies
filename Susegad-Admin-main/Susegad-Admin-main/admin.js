document.addEventListener('DOMContentLoaded', () => {
  ...
  const toastContainer = document.getElementById('toast-container'); // Assuming this exists
  ...
  // NOTE: You would need to define and attach the Stock/Price edit/save handlers here, 
  // but they were removed for brevity in this final combined file.

  // -----------------------------------------------------------
  // --- Initial Load & Event Listeners ---
  // -----------------------------------------------------------

  // Attaching event listeners that rely on DOM elements being present
  // You should re-attach your full set of listeners here if you remove the individual logic

  // Initial data load calls (MUST run after DOMContentLoaded)
  loadProducts();
  loadCategories();
  loadOrders();
});